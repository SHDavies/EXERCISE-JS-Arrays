...
*/
  ...
  //Code Here
var removeItem = function(list, boughtItem) {
  var listPlace = list.indexOf(boughtItem);
  if(listPlace !== -1) {
    list.splice(listPlace, 1);
  }
  return list;
}
...
var addTen = function(arr) {
  for (var i = 0; i < arr.length; i++) {
    arr.splice(i, 1, parseInt(arr[i]) + 10);
  }
  return arr;
}
...
var user3 = {
  name: 'Holly Davies',
  email: 'hcdavies2011@gmail.com',
  password: 'password4321',
  username: 'holly_cow28'
}
